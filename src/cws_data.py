...
from cws_globals import (
    UNION, CONFEDERATE, NUM_ARMIES, NUM_CITIES, UNION_ARMY_END,
)
...
def _filer_case1(g: 'GameState') -> None:
    ...
    for i in range(1, NUM_ARMIES + 1):                                # L5
...
def occupy(g: 'GameState', x: int) -> None:
    ...
    """
    g.occupied[x] = 0                                                # L113
    for i in range(1, NUM_ARMIES + 1):                                # L114
...
def load_cities(g: 'GameState') -> None:
    ...
    for i in range(1, NUM_CITIES + 1):                                # L95
