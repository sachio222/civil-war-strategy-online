...
from cws_globals import UNION, CONFEDERATE, NUM_ARMIES, NUM_CITIES
...
def _select_port(g: 'GameState', who: int, chx: int, cost: int, a: int) -> str:
    ...
    while True:                                             # ships: loop (L127)
        ...
        for i in range(1, NUM_CITIES + 1):                              # L117
        ...
        while True:                                         # cannon loop
            ...
            while True:                                     # wave loop
                ...
                if g.choose == 1:                           # CASE 1: Attack
                    ...
                    target = 0                              # L403
                    for i in range(1, NUM_CITIES + 1):                   # L404-406
                        if g.cityp[i] == who:
    ...
    while True:                                             # ahoy: (L43)
        ...
        while True:  # anchor dispatch loop
            ...
            # ──────────── CASE 3: Sail ────────────────────
                ...
                g.size = 0                                  # L204
                for i in range(1, NUM_CITIES + 1):                      # L205
...
def integrity(g: 'GameState') -> None:
    ...
    for i in range(1, NUM_CITIES + 1):                                  # L474
