...
When running from source: data files are in <project_root>/data/ (one level up
from src/, then into data/).
...
or to the data directory in source mode.
"""
...
if getattr(sys, 'frozen', False):
    ...
    # Running from source — data files in <project_root>/data/
