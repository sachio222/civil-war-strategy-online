...
from cws_globals import UNION, CONFEDERATE, NUM_CITIES
...
def newcity(g: 'GameState', index: int) -> int:
    ...
    while True:                                                      # L5: morecap:
        ...
        g.array[2] = index                                           # let menu draw the arrow
        menu(g, 3)                                                   # L8
        clrrite(g)                                                   # L8
        ...
        if g.choose == -27:                                          # L10: CASE IS = -27
            ...
            x = 0                                                    # L14
            found_letter = False
            for k in range(1, NUM_CITIES + 1):                        # L15
