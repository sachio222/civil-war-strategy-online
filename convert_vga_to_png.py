...
Output goes to cws-online/client/assets/sprites/.
...
# VGA 16-color palette (same as constants.py VGA_RGB)
VGA_RGB = [
...
OUT_DIR = os.path.join(ROOT, "cws-online", "client", "assets", "sprites")
...
def main():
    ...
    for name in sprites:
        vga_path = os.path.join(ROOT, f"{name}.VGA")
    ...
    for i in range(1, 6):
        vga_path = os.path.join(ROOT, f"FACE{i}.VGA")
